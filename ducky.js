...
window.onload = function () {
  ...
  function createDuck() {
    ...
    duck.style.left = Math.random() * window.innerHeight + 'px';
    document.body.appendChild(duck);
    let duckFlap = setInterval(function flapper() {
    ...
    function moveDuck() {
      ...
      function duckShot() {
        ...
        setTimeout(function () { duck.remove(); isWinner() }, 2000)
      }

      duck.addEventListener('click', duckShot);
    }

    moveDuck()
    let mover = setInterval(moveDuck, 2000);
    return duck;
  };
